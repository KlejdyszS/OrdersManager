...
const OrderForm = ({
  ...
  const handleRemovePair = (index) => {
    ...
    handleInputChange({
      target: {
        name: 'model',
        value: newPairs, // Update newOrder with the updated model pairs
      },
    });
  };
                  ...
                  {modelPairs.map((pair, index) => (
                    <div key={index} className="mb-2">
                      ...
                      <input
                        ...
                        className="border-gray-300 focus:ring-blue-200 focus:ring-opacity-50 rounded-md shadow-sm w-1/2 py-2 px-3"
                        />
                        <button
                        type="button"
